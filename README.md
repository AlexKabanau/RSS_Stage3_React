...
- **_Filter countries by region (All -> Antarctic)_**
...
- **_Filter countries by region(Antarctic -> Americas)_**
...
- **_Filter countries by region(Americas -> Europe)_**
...
- **_Filter countries by region(Europe -> Africa)_**
...
- **_Filter countries by region(Africa -> Asia)_**
...
- **_Filter countries by region(Asia -> Oceania)_**
...
- **_Filter countries by region(Oceania -> All)_**
...
- **_Sort countries by population(population DESC -> population ASC)_**
...
- **_Sort countries by name(population ASC -> name ASC)_**
...
- **_Toggle visited for US and India_**
...
![Flame Graph](/src/assets/images/after/image-23.png)

#### 2️⃣ **Ranked Chart**

![Ranked Chart](/src/assets/images/after/image-24.png)
...
![Flame Graph](/src/assets/images/after/image-25.png)

#### 2️⃣ **Ranked Chart**

![Ranked Chart](/src/assets/images/after/image-26.png)
...
![Flame Graph](/src/assets/images/after/image-27.png)

#### 2️⃣ **Ranked Chart**

![Ranked Chart](/src/assets/images/after/image-28.png)
...
![Flame Graph](/src/assets/images/after/image-29.png)

#### 2️⃣ **Ranked Chart**

![Ranked Chart](/src/assets/images/after/image-30.png)
...
![Flame Graph](/src/assets/images/after/image-31.png)

#### 2️⃣ **Ranked Chart**

![Ranked Chart](/src/assets/images/after/image-32.png)
...
![Flame Graph](/src/assets/images/after/image-33.png)

#### 2️⃣ **Ranked Chart**

![Ranked Chart](/src/assets/images/after/image-34.png)
...
![Flame Graph](/src/assets/images/after/image-35.png)

#### 2️⃣ **Ranked Chart**

## ![Ranked Chart](/src/assets/images/after/image-36.png)
...
- **Commit Duration:** ~~1.9s~~ 1.9s (без изменений)
- **Максимальное время рендеринга компонента:** ~~28ms~~ 3.4ms (улучшение на 87%) (Компонент `<HomePage>`)
- **Наиболее затратный компонент:** ~~27ms~~ 2.3ms (улучшение на 91%) `<ListItems> (Memo)`
- **Количество повторных рендеров:** ~~3~~ 2 (улучшение на 30%)
...
![Flame Graph](/src/assets/images/after/image-37.png)

#### 2️⃣ **Ranked Chart**

![Ranked Chart](/src/assets/images/after/image-38.png)
...
- **Commit Duration:** ~~3s~~ 2.2s (улучшение на 26%)
- **Максимальное время рендеринга компонента:** ~~34.9ms~~ 3.7ms (улучшение на 89%) (Компонент `<HomePage>`)
- **Наиболее затратный компонент:** ~~34.1ms~~ 1.7ms (улучшение на 95%) `<ListItems> (Memo)`
- **Количество повторных рендеров:** ~~3~~ 2 (улучшение на 30%)
...
![Flame Graph](/src/assets/images/after/image-39.png)

#### 2️⃣ **Ranked Chart**

![Ranked Chart](/src/assets/images/after/image-40.png)
...
- **Commit Duration:** ~~2s~~ 2.3s (ухудшение на 15%)
- **Максимальное время рендеринга компонента:** ~~30.6ms~~ 1.1ms (улучшение на 96%) (Компонент `<HomePage>`)
- **Наиболее затратный компонент:** ~~28.7~~ 1.1ms (улучшение на 96%) `<ListItems> (Memo)`
- **Количество повторных рендеров:** ~~14~~ 9 (улучшение на 36%)

### 📊 Графики профилирования:

#### 1️⃣ **Flame Graph**

![Flame Graph](/src/assets/images/after/image-41.png)

#### 2️⃣ **Ranked Chart**

![Ranked Chart](/src/assets/images/after/image-42.png)
...
![Flame Graph](/src/assets/images/after/image-21.png)

#### 2️⃣ **Ranked Chart**

## ![Ranked Chart](/src/assets/images/after/image-22.png)
